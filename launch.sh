...
if [ ! -d "sdk-tools/$sdkTools" ]; then
  ...
  yes | ./sdk-tools/$sdkTools/tools/bin/sdkmanager "platform-tools" "platforms;android-$version" "emulator" "system-images;android-$version;google_apis;x86"
touch /home/claudio/.android/repositories.cfg
  ./sdk-tools/$sdkTools/tools/bin/avdmanager create avd --name test --package "system-images;android-$version;google_apis;x86" --device "Nexus 5X"
fi
